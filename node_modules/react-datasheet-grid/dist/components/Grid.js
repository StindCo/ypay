...
const Grid = ({ data, columns, outerRef, innerRef, columnWidths, hasStickyRightColumn, displayHeight, headerRowHeight, rowHeight, rowKey, fullWidth, selection, activeCell, rowClassName, cellClassName, children, editing, getContextMenuItems, setRowData, deleteRows, duplicateRows, insertRowAfter, stopEditing, }) => {
    var _a, _b, _c, _d;
    ...
    return (react_1.default.createElement("div", { ref: outerRef, className: "dsg-container", style: { height: displayHeight } },
